...
use App\Models\Import\BoschFPA5000\LSNI\FULLEON_STANDALONE_V;
use App\Services\Import\BoschFPA5000\OtherBase_Element;
use SimpleXMLElement;

class FULLEON_STANDALONE_V_Element extends OtherBase_Element
{
    protected FULLEON_STANDALONE_V $lsni;

    public function __construct(SimpleXMLElement $x)
    {
        parent::__construct($x);

        $this->lsni = new FULLEON_STANDALONE_V();
        $this->lsni->save();
        $this->lsni->BASE()->save($this->baseElement);
    }
}

// <xs:complexType name="LSN_FulleonVoiceSounderWithBatteryType">
// <xs:complexContent>
...
//             <xs:element name="drillPattern" type="nacPatternType" default="MP_ACM_SIGNAL01"/>
//             <xs:element name="drillVolume" default="5" base="xs:unsignedByte"/>
//             <xs:element name="testActivationPattern" type="nacPatternType" default="MP_ACM_SIGNAL01"/>
