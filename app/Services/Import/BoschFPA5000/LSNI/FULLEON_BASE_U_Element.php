...
use App\Models\Import\BoschFPA5000\LSNI\FULLEON_BASE_U;
use App\Services\Import\BoschFPA5000\OtherBase_Element;
use SimpleXMLElement;

class FULLEON_BASE_U_Element extends OtherBase_Element
{
    protected FULLEON_BASE_U $lsni;

    public function __construct(SimpleXMLElement $x)
    {
        parent::__construct($x);

        $this->lsni = new FULLEON_BASE_U();
        $this->lsni->save();
