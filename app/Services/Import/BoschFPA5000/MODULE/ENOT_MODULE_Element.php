...
use App\Models\Import\BoschFPA5000\Modules\ENOT_MODULE;
use App\Services\Import\BoschFPA5000\PANEL_MODULES_Base_Element;
use SimpleXMLElement;

class ENOT_MODULE_Element extends PANEL_MODULES_Base_Element
{
    private ENOT_MODULE $module;

    public function __construct(SimpleXMLElement $x)
    {
        parent::__construct($x);

        $this->module = new ENOT_MODULE(/*(array)$x*/);
        $this->module->save();
