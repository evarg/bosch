...
use App\Models\Import\BoschFPA5000\Modules\IO2_S20_MODULE;
use App\Services\Import\BoschFPA5000\PANEL_MODULES_Base_Element;
use SimpleXMLElement;

class IO2_S20_MODULE_Element extends PANEL_MODULES_Base_Element
{
    private IO2_S20_MODULE $module;

    public function __construct(SimpleXMLElement $x)
    {
        parent::__construct($x);

        $this->module = new IO2_S20_MODULE(/*(array)$x*/);
        $this->module->save();
