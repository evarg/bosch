...
use App\Models\Import\BoschFPA5000\Modules\LEDINT_MODULE;
use App\Services\Import\BoschFPA5000\PANEL_MODULES_Base_Element;
use SimpleXMLElement;

class LEDINT_MODULE_Element extends PANEL_MODULES_Base_Element
{
    private LEDINT_MODULE $module;

    public function __construct(SimpleXMLElement $x)
    {
        parent::__construct($x);

        $this->module = new LEDINT_MODULE(/*(array)$x*/);
        $this->module->save();
