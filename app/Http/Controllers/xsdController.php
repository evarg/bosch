...
class xsdController extends Controller
{
    ...
    {
        $reader = XmlReader::fromFile(storage_path('xsl\\skrypty\\All-3-0-0.xsd'));
        ...
        $typeNames = $globalTypes['xs:schema']->getContent()['xs:simpleType']->getContent();
