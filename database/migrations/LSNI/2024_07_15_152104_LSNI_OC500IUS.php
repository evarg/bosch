...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->create('LSNI_OC500IUS', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->dropIfExists('LSNI_OC500IUS');
    }
};

// <xs:complexType name="OC500IUSType">
// 	<xs:complexContent>
