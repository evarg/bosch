...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->create('LSNI_RAS_TPS1', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->dropIfExists('LSNI_RAS_TPS1');
    }
};

// <xs:element name="RAS_TPS1">
// 	<xs:complexType>
// 		<xs:complexContent>
