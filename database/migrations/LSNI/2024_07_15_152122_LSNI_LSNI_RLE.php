...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->create('LSNI_LSNI_RLE', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->dropIfExists('LSNI_LSNI_RLE');
    }
};

// <xs:complexType name="LSNI_RLEType">
// 	<xs:complexContent>
...
// 				<xs:element name="RELAY" type="LSNI_RELAYFeedbackRLEType"/>
// 				<xs:element name="INPUT" type="INPUTBaseType" minOccurs="0" maxOccurs="2"/>
// 			</xs:sequence>
// 		</xs:extension>
// 	</xs:complexContent>
// </xs:complexType>
