...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->create('LSNI_RAS_TTS2', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->dropIfExists('LSNI_RAS_TTS2');
    }
};

// <xs:element name="RAS_TTS2">
// 	<xs:complexType>
// 		<xs:complexContent>
