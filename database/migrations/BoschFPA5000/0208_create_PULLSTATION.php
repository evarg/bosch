...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->create('PULLSTATION', function (Blueprint $table) {
            $table->id();

            $table->string('lsnTypeID')->nullable();
            $table->string('lsnSubtype')->nullable();
            $table->string('backPointer')->nullable();
            ...
            $table->string('standbyLEDblinking')->nullable();
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->dropIfExists('PULLSTATION');
    }
};
