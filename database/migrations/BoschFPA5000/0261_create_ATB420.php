...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->create('ATB420', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('buzzerActivity')->nullable();
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->dropIfExists('ATB420');
    }
};
