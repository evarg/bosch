...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->create('LSNI_LSNI_OUT1_IN1', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->dropIfExists('LSNI_LSNI_OUT1_IN1');
    }
};
