...
return new class extends Migration
{
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->create('LSNI_LSNI_OUT2_D', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('mysql_BoschFPA5000')->dropIfExists('LSNI_LSNI_OUT2_D');
    }
};

// <xs:complexType name="LSNI_OUT2Type">
// 	<xs:complexContent>
...
// 				<xs:element name="OUTPUT" type="LSNI_OUT2_OUTPUTType" minOccurs="2" maxOccurs="2"/>
// 			</xs:sequence>
// 		</xs:extension>
// 	</xs:complexContent>
// </xs:complexType>
