...
@section('title', 'Dashboard - Podsumowanie')
...
<div class="row gy-4">
  ...
  <div class="col-md-12 col-lg-4">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title mb-1">Konfiguracja</h4>
        <p class="pb-0">Podsumowanie</p>
        <a href="javascript:;" class="btn btn-sm btn-primary">Zobacz</a>
      </div>
      <img src="{{asset('assets/img/bosch-logo.png')}}" class="scaleX-n1-rtl position-absolute bottom-0 end-0 me-4 mb-4 pb-2" width="120" alt="view sales">
    </div>
  </div>
    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex align-items-center justify-content-between">
          <h5 class="card-title m-0 me-2">Elementy</h5>
          <div class="dropdown">
        ...
        <div class="row g-3">
          <div class="col-md-3 col-6">
            <div class="d-flex align-items-center">
              ...
              <div class="ms-3">
                <div class="small mb-1">Czujki dymu</div>
          ...
          <div class="col-md-3 col-6">
            <div class="d-flex align-items-center">
              ...
              <div class="ms-3">
                <div class="small mb-1">Czujki temp.</div>
