                        ...
                        <div class="dt-action-buttons d-flex align-items-center justify-content-sm-center gap-2">
                            ...
                            <div class="dt-buttons flex-wrap">
                                <button
                                    ...
                                    aria-expanded="false">
                                    <span><i class="ri-upload-2-line ri-16px me-2"></i><span
                                            class="d-none d-sm-inline-block">Export
                                        </span></span>
                                </button>
                                <button class="btn btn-outline-secondary btn-gr" tabindex="0"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="sorting sorting_desc" tabindex="0" aria-controls="DataTables_Table_0"
                                rowspan="1" colspan="1" style="width: 290px" aria-sort="descending"
                                aria-label="User: activate to sort column ascending">
                                User
                            </th>
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="width: 346px" aria-label="Email: activate to sort column ascending">
                                Email
                            </th>
                            ...
                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 283px"
                                aria-label="Actions">
                                Actions
                            </th>
                        </tr>
                        ...
                        <div class="dataTables_paginate paging_simple_numbers" id="DataTables_Table_0_paginate">
                            <ul class="pagination">
                                ...
                                <li class="paginate_button page-item next disabled" id="DataTables_Table_0_next">
                                    <a aria-controls="DataTables_Table_0" aria-disabled="true" role="link"
                                        data-dt-idx="next" tabindex="-1" class="page-link">Next</a>
                                </li>
                            </ul>
                        </div>
                    </div>
